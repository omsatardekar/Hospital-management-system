export type Role = 'ADMIN' | 'OPS_MANAGER' | 'FINANCE' | 'PHARMACY' | 'LAB' | 'DOCTOR' | 'PHARMACIST'
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ADMIN: [
    'dashboard:view', 'patients:read', 'patients:write', 'doctors:read', 'doctors:write',
    'appointments:read', 'appointments:write', 'billing:read', 'billing:write',
    'pharmacy:read', 'pharmacy:write', 'lab:read', 'lab:write', 'users:read',
    'users:write', 'audit:read', 'reports:read', 'settings:read', 'settings:write',
  ],
  OPS_MANAGER: [
    'dashboard:view', 'patients:read', 'patients:write', 'doctors:read', 'doctors:write',
    'appointments:read', 'appointments:write', 'audit:read', 'reports:read', 'settings:read',
  ],
